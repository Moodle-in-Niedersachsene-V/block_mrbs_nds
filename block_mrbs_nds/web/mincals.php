...
//
    ...
    class Calendar
    {
        ...
        public function getDateLink($day, $month, $year)
        {
            ...
            $returl = new moodle_url('/blocks/mrbs_nds/web/' . $isuser . $this->dmy . '.php', ['year' => $year, 'month' => $month, 'day' => $day, 'area' => $this->area]);
            if (!empty($this->usertt)) {
        ...
        public function getHTML()
        {
			...
			$first = (date('N', $date) + 7 - $weekstarts) % 7;
            $monthName = userdate($date, get_string('strftimemonth', 'langconfig'));
