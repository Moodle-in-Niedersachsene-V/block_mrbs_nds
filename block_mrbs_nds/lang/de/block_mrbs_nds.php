...
// $Id: block_mrbs_nds.php,v 1.11 2009/11/07 14:50:34 arborrow Exp $
...
// Bearbeitung 20190117 Patrick Liersch
$string['about_mrbs_rlp'] = 'Über MRBS';
$string['accessdenied'] = 'Zugang verweigert';
$string['accessmrbs_rlp'] = 'Ressourcen verwalten';
...
$string['blockname'] = 'Buchungssystem (RLP)';
$string['booking_users'] = 'Nutzer für Buchung';
$string['booking_users_help'] = 'Tragen Sie hier eine kommagetrennte Liste von E-Mail-Adressen der Nutzer/innen ein, die diese Ressource oder dieses Gerät buchen dürfen. Wenn Sie das Feld leer lassen, dürfen alle Nutzer/innen buchen.';
$string['bookingmoved'] = 'Eine Ihrer Buchungen wurde geändert';
$string['bookingmovedmessage'] = 'Ihre Buchung {$a->name} wurde von \'{$a->oldroom}\' nach \'{$a->newroom}\' im Bereich \'{$a->area}\' geändert. Dies betrifft den Termin {$a->date} - {$a->starttime}. Die Ressource bzw. das Gerät wird benötigt von {$a->newbookingname}. ACHTUNG: Diese Umbuchung wurde automatisch durchgeführt! Kontrollieren Sie unbedingt, ob dieser Ersatz für Sie brauchbar ist!';
...
$string['clashemailbody'] = 'Während des aktuellen Imports gab es einen Konflikt bei der Buchuung: Um {$a->time} benutzen {$a->oldbooking} und {$a->newbooking} beide gleichzeitig die Ressource {$a->room}. Korrigieren Sie das Problem, um unnötige Störungen zu vermeiden. DIES IST DIE EINZIGE WARNUNG DIESES KONFLIKTS. WENN SIE DIESE E-MAIL IGNORIEREN KANN ES ZU PROBLEMEN KOMMEN. Die Mail wurde automatisch vom Buchungssystem versendet. Wenn Sie denken, dass  hier ein Fehler vorliegt, kontaktieren Sie den Administrator {$a->admin}';
...
$string['config_default_room2'] = 'Standardmäßig wird diese Ressource beim Aufruf des Buchungssystems gezeigt. Die Ressource- bzw. Gerätennummer lässt sich über den Link herausfinden.';
...
$string['config_mail_room_admin_on_bookings2'] = 'Der Ressourceadmin wird per E-Mail über neue Buchungen seiner Räume informiert.';
...
$string['dontshowoccupied'] = 'Belegte Räume nicht anzeigen ';
...
$string['findroom'] = 'Ressourcen suchen';
...
$string['help_wildcard'] = 'Hinweis: Benutzen Sie das Symbol % als Wildcard in den Suchfeldern.';
...
$string['match_room'] = 'Suche Ressourcen';
...
$string['mrbs_rlp:administermrbs'] = 'Zugriff MRBS (lesen / schreiben / admin)';
$string['mrbs_rlp:editmrbs'] = 'Zugriff MRBS (lesen / schreiben)';
$string['mrbs_rlp:doublebook'] = 'Doppelbuchungen vornehmen';
$string['mrbs_rlp:editmrbs_unconfirmed'] = 'Only create \'unconfirmed\' bookings (overriden by \'editmrbs\')';
$string['mrbs_rlp:forcebook'] = 'Buchungen überschreiben (vorherige Buchungen automatisch verschieben)';
$string['mrbs_rlp:viewalltt'] = 'Alle Buchungen sehen';
$string['mrbs_rlp:viewmrbs'] = 'Zugriff MRBS (nur lesen)';
$string['mrbs_rlp'] = 'Buchungssystem (RLP)';
$string['mrbs_rlpadmin'] = 'MRBS Administrator (RLP)';
$string['mrbs_rlpadmin_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem MRBS verwalten, Bereiche und Räume anlegen, Buchungen aller Personen ändern, Buchungen erzwingen und Doppelbuchungen vornehmen.';
$string['mrbs_rlpeditor'] = 'MRBS Editor (RLP)';
$string['mrbs_rlpeditor_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem MRBS benutzen, eigene Buchungen vornehmen, ändern und löschen, außerdem alle Buchungen sehen.';
$string['mrbs_rlpviewer'] = 'MRBS Viewer (RLP)';
$string['mrbs_rlpviewer_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem MRBS nur sehen, aber keine Änderungen vornehmen.';
...
$string['no_rooms_for_area'] = 'Der Bereich enthält keine Räume';
...
$string['norooms'] = 'Keine Ressourcen vorhanden';
$string['noroomsfound'] = 'Keine Ressourcen gefunden';
...
$string['pluginname'] = 'Buchungssystem (RLP)';
...
$string['requestvacate'] = 'Anfrage ob diese Ressource umgebucht werden kann';
...
$string['roomsearch'] = 'Ressource suchen';
...
$string['specialroom'] = 'Nur Spezialräume';
...
$string['teachingroom'] = 'Nur Unterrichtsräume';
$string['through'] = ' bis ';
...
// ── Neue Strings Phase 1+2 (block_mrbs_nds) ──────────────────────────────────
$string['accessmrbs_nds']      = 'Raumbucher öffnen';
$string['crontask']            = 'MRBS NDS – Hintergrundaufgabe (Kalenderimport)';
$string['about_mrbs_nds']      = 'Über den MRBS NDS Raumbuchungsblock';
$string['mrbs_nds']            = 'MRBS NDS Raumbuchung';
$string['blockname']           = 'MRBS NDS Raumbuchung';
$string['classsize']           = 'Klassengröße';
$string['bookings']            = 'Buchungen';
$string['accessdenied']        = 'Zugriff verweigert';
$string['must_set_name']       = 'Bitte geben Sie einen Buchungsnamen ein.';
$string['must_set_description'] = 'Bitte geben Sie eine Beschreibung ein.';
$string['notallowedbook']      = 'Sie sind nicht berechtigt, diesen Raum zu buchen.';

// Privacy API strings
$string['privacy:metadata:block_mrbs_nds_entry']              = 'Einzelbuchungen des Raumbuchungssystems';
$string['privacy:metadata:block_mrbs_nds_entry:create_by']    = 'Moodle-Nutzer-ID der buchenden Person';
$string['privacy:metadata:block_mrbs_nds_entry:name']         = 'Bezeichnung der Buchung';
$string['privacy:metadata:block_mrbs_nds_entry:description']  = 'Beschreibung der Buchung';
$string['privacy:metadata:block_mrbs_nds_entry:start_time']   = 'Startzeit der Buchung';
$string['privacy:metadata:block_mrbs_nds_entry:end_time']     = 'Endzeit der Buchung';
$string['privacy:metadata:block_mrbs_nds_repeat']             = 'Serienbuchungen des Raumbuchungssystems';
$string['privacy:metadata:block_mrbs_nds_repeat:create_by']   = 'Moodle-Nutzer-ID der buchenden Person';
$string['privacy:metadata:block_mrbs_nds_repeat:name']        = 'Bezeichnung der Serienbuchung';
$string['privacy:metadata:block_mrbs_nds_repeat:description'] = 'Beschreibung der Serienbuchung';
$string['privacy:metadata:block_mrbs_nds_repeat:start_time']  = 'Startzeit der ersten Buchung';
$string['privacy:metadata:block_mrbs_nds_repeat:end_time']    = 'Endzeit der ersten Buchung';

$string['from'] = 'Von';
$string['eventbookingcreated'] = 'Buchung erstellt';
$string['eventbookingupdated'] = 'Buchung geändert';
$string['confirmed']     = 'Bestätigt';
$string['free_click']    = 'Frei – klicken zum Buchen';
$string['gototoday']     = 'Heute';
$string['moredetails']   = 'Vollformular';
$string['userweek']      = 'Meine Woche';
