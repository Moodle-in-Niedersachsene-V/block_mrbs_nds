...
$string['blockname'] = 'MRBS Raumbuchung';
...
$string['mrbs_nds'] = 'MRBS Raumbuchung';
$string['blockname'] = 'MRBS Raumbuchung';
...
// Privacy API strings
$string['privacy:metadata:block_mrbs_rlp_entry']              = 'Einzelbuchungen des Raumbuchungssystems';
$string['privacy:metadata:block_mrbs_rlp_entry:create_by']    = 'Moodle-Nutzer-ID der buchenden Person';
$string['privacy:metadata:block_mrbs_rlp_entry:name']         = 'Bezeichnung der Buchung';
$string['privacy:metadata:block_mrbs_rlp_entry:description']  = 'Beschreibung der Buchung';
$string['privacy:metadata:block_mrbs_rlp_entry:start_time']   = 'Startzeit der Buchung';
$string['privacy:metadata:block_mrbs_rlp_entry:end_time']     = 'Endzeit der Buchung';
$string['privacy:metadata:block_mrbs_rlp_repeat']             = 'Serienbuchungen des Raumbuchungssystems';
$string['privacy:metadata:block_mrbs_rlp_repeat:create_by']   = 'Moodle-Nutzer-ID der buchenden Person';
$string['privacy:metadata:block_mrbs_rlp_repeat:name']        = 'Bezeichnung der Serienbuchung';
$string['privacy:metadata:block_mrbs_rlp_repeat:description'] = 'Beschreibung der Serienbuchung';
$string['privacy:metadata:block_mrbs_rlp_repeat:start_time']  = 'Startzeit der ersten Buchung';
$string['privacy:metadata:block_mrbs_rlp_repeat:end_time']    = 'Endzeit der ersten Buchung';
