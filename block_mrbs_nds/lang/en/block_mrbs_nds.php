...
$string['about_mrbs_rlp'] = 'About MRBS';
$string['accessdenied'] = 'Access Denied';
$string['accessmrbs_rlp'] = 'Schedule a Resource (Computer Room)';
...
$string['config_max_advance_days2'] = 'The maximum days in advance you can make a booking (-1) to disable. Users with capability \'mrbs_rlp:ignoremaxadvancedays\' (by default, site or mrbs_rlp admins) will still be able to make bookings further in advance than this.';
...
$string['mrbs_rlp:addinstance'] = 'Add MRBS block to My Moodle page';
$string['mrbs_rlp:administermrbs'] = 'Access MRBS (Read / Write / Admin)';
$string['mrbs_rlp:editmrbs'] = 'Access MRBS (Read / Write)';
$string['mrbs_rlp:doublebook'] = 'Double Book Rooms';
$string['mrbs_rlp:editmrbs_unconfirmed'] = 'Only create \'unconfirmed\' bookings (overriden by \'editmrbs\')';
$string['mrbs_rlp:forcebook'] = 'Force Book Rooms (auto move existing bookings)';
$string['mrbs_rlp:ignoremaxadvancedays'] = 'Ignore the \'max_advance_days\' setting';
$string['mrbs_rlp:myaddinstance'] = 'Add new MRBS block';
$string['mrbs_rlp:viewalltt'] = 'View All Users\' Timetables';
$string['mrbs_rlp:viewmrbs'] = 'Access MRBS (Read only)';
$string['mrbs_rlp'] = 'Meeting Room Booking System';
$string['mrbs_rlpadmin'] = 'MRBS administrator';
$string['mrbs_rlpadmin_desc'] = 'Users with this role (at the system level) can fully configure an MRBS timetable: create areas and rooms, edit other people\'s bookings, force bookings and double-book rooms';
$string['mrbs_rlpeditor'] = 'MRBS editor';
$string['mrbs_rlpeditor_desc'] = 'Users with this role (at the system level) can make bookings using MRBS and edit their own bookings';
$string['mrbs_rlpviewer'] = 'MRBS viewer';
$string['mrbs_rlpviewer_desc'] = 'Users with this role (at the system level) can view the MRBS timetable, but cannot make any changes';
...
$string['specialroom'] = 'Special rooms only';
...
// ── New strings Phase 1+2 (block_mrbs_nds) ───────────────────────────────────
$string['accessmrbs_nds']      = 'Open room booker';
$string['crontask']            = 'MRBS NDS – Background task (calendar import)';
$string['about_mrbs_nds']      = 'About the MRBS NDS room booking block';
$string['mrbs_nds']            = 'MRBS NDS Room Booking';
$string['blockname']           = 'MRBS NDS Room Booking';
$string['classsize']           = 'Class size';
$string['bookings']            = 'Bookings';
$string['accessdenied']        = 'Access denied';
$string['must_set_name']       = 'Please enter a booking name.';
$string['must_set_description'] = 'Please enter a description.';
$string['notallowedbook']      = 'You are not allowed to book this room.';

// Privacy API strings
$string['privacy:metadata:block_mrbs_nds_entry']              = 'Individual booking entries in the room booking system';
$string['privacy:metadata:block_mrbs_nds_entry:create_by']    = 'Moodle user ID of the person who made the booking';
$string['privacy:metadata:block_mrbs_nds_entry:name']         = 'Name of the booking';
$string['privacy:metadata:block_mrbs_nds_entry:description']  = 'Description of the booking';
$string['privacy:metadata:block_mrbs_nds_entry:start_time']   = 'Start time of the booking';
$string['privacy:metadata:block_mrbs_nds_entry:end_time']     = 'End time of the booking';
$string['privacy:metadata:block_mrbs_nds_repeat']             = 'Recurring booking series in the room booking system';
$string['privacy:metadata:block_mrbs_nds_repeat:create_by']   = 'Moodle user ID of the person who created the series';
$string['privacy:metadata:block_mrbs_nds_repeat:name']        = 'Name of the booking series';
$string['privacy:metadata:block_mrbs_nds_repeat:description'] = 'Description of the booking series';
$string['privacy:metadata:block_mrbs_nds_repeat:start_time']  = 'Start time of the first booking in the series';
$string['privacy:metadata:block_mrbs_nds_repeat:end_time']    = 'End time of the first booking in the series';

$string['from'] = 'From';
$string['eventbookingcreated'] = 'Booking created';
$string['eventbookingupdated'] = 'Booking updated';
$string['confirmed']     = 'Confirmed';
$string['free_click']    = 'Free – click to book';
$string['gototoday']     = 'Today';
$string['moredetails']   = 'Full form';
$string['userweek']      = 'My week';
