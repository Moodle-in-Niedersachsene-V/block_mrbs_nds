...
$string['blockname'] = 'MRBS Room Booking';
...
$string['mrbs_nds'] = 'MRBS Room Booking';
$string['blockname'] = 'MRBS Room Booking';
...
// Privacy API strings
$string['privacy:metadata:block_mrbs_rlp_entry']              = 'Individual booking entries in the room booking system';
$string['privacy:metadata:block_mrbs_rlp_entry:create_by']    = 'Moodle user ID of the person who made the booking';
$string['privacy:metadata:block_mrbs_rlp_entry:name']         = 'Name of the booking';
$string['privacy:metadata:block_mrbs_rlp_entry:description']  = 'Description of the booking';
$string['privacy:metadata:block_mrbs_rlp_entry:start_time']   = 'Start time of the booking';
$string['privacy:metadata:block_mrbs_rlp_entry:end_time']     = 'End time of the booking';
$string['privacy:metadata:block_mrbs_rlp_repeat']             = 'Recurring booking series in the room booking system';
$string['privacy:metadata:block_mrbs_rlp_repeat:create_by']   = 'Moodle user ID of the person who created the series';
$string['privacy:metadata:block_mrbs_rlp_repeat:name']        = 'Name of the booking series';
$string['privacy:metadata:block_mrbs_rlp_repeat:description'] = 'Description of the booking series';
$string['privacy:metadata:block_mrbs_rlp_repeat:start_time']  = 'Start time of the first booking in the series';
$string['privacy:metadata:block_mrbs_rlp_repeat:end_time']    = 'End time of the first booking in the series';
